...
export function ChatInput() {
  ...
  return (
    <form
      onSubmit={submit}
      className="relative z-20 shrink-0 border-t bg-background/95 px-3 py-2 pb-[calc(2.25rem+env(safe-area-inset-bottom))] sm:px-4 sm:pb-[calc(0.75rem+env(safe-area-inset-bottom))]"
    >
